...
function InputBox({label, amount, onAmountChange, onCurrencyChange, currencyOptions=[], selectCurrency = "usd",className = "",}) {
        ...
        <div className={`bg-white p-3 rounded-lg text-sm flex ${className}`}>
            <div className="w-1/2">
                ...
                <input 
                    autoFocus
                    id={amountInputId}
                    className="w-full bg-transparent py-1.5 text-black"
                    type="number"
                    placeholder="Amount"
                    value={amount}
            ...
            <div className="w-1/2 flex flex-wrap justify-end text-right">
                ...
                >
                    {/* Remember the key in loops in React for improving performnce*/}
